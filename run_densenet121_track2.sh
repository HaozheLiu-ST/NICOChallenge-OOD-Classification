...
--dist-backend 'nccl' \
--world-size 1 \
--moco_pretrained '/apdcephfs/share_1290796/jinhengxie/NICO/train/Scaled-down-self-supervised-learning-main/moco/checkpoints/finetune/224/densenet121_track2/gpus_4_lr_0.03_bs_128_epochs_800_path_/checkpoint_0620.pth.tar' \
