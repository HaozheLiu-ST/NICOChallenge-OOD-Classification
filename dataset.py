...
class Valid_Dataset(Dataset):
    def __init__(self, img_size, data, use_seg=True, img_transformer=None, root='./Datasets/NICO/nico_datasets/'):
        self.data = data
        self.root = root
...
class Train_Dataset(Dataset):
    def __init__(self, img_size, data, task='track1', use_seg=True, root='', transformer=None):
        self.data = data
        self._task = task
        self.root = root
...
class FDG_Dataset_Seg(Dataset):
    def __init__(self, img_size, data, task, root='./Datasets/NICO/nico_datasets/', transformer=None):
