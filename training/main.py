...
# |-Data initilization
    ...
    if args.track == '2':
        train_loader, val_loader = get_data('track2',args.batch_size, use_seg=True,cfg='pairrandomcrop')
    else:
        train_loader, val_loader = get_data('track1',args.batch_size, use_seg=True,cfg='pairrandomcrop')
