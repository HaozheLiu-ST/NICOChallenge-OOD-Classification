...
from dataset_seg import get_fourier_train_dataset_cross
...
# |-Data initilization
    ...
    if args.track == '2':
        train_dataset, valid_dataset = get_fourier_train_dataset_cross('track2','track1', args.root, args.batch_size, use_seg=True)
    else:
        train_dataset, valid_dataset = get_fourier_train_dataset_cross('track1','track2', args.root, args.batch_size, use_seg=True)
