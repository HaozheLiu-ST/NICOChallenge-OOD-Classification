...
if __name__ == '__main__':
    ...
    pred_dir = create_directory(f'./WSSS/experiments/predictions/{experiment_name}/')

    cam_path = create_directory(f'{args.vis_dir}/{experiment_name}/')

    model_path = './WSSS/experiments/models/' + f'{args.tag}.pth'
    print(model_path)

    # mapping
    import json

    with open('./data/dg_label_id_mapping.json', 'r') as file:
