...
import moco.loader_phase2
import moco.builder
from moco.ssl_loader import SSLDataset

from PIL import ImageFile
"""
修改Dataset以适应Track1文件路径
"""
...
def main():
    ...
    args.save_dir = os.path.join(args.save_dir, 'finetune', str(args.input_size), args.arch + f'_{args.track}_{args.moco_k}_{args.lr}_{args.batch_size}')
    if args.pretrained:
        args.save_dir = os.path.join(args.save_dir, 'pretrained_from_{}'.format(args.pretrained.split('/')[-1]))
    args.save_dir = os.path.join(args.save_dir, 'gpus_{}_lr_{}_bs_{}_epochs_{}'.format(len(args.gpus.split(',')),
                                                                                     args.lr,
                                                                                     args.batch_size,
                                                                                     args.epochs))
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    # print(args.arch, official_model_names)
    ...
    if args.aug_plus:
        ...
        augmentation = [
            ...
            transforms.RandomApply([moco.loader_phase2.GaussianBlur([.1, 2.])], p=0.5),
    ...
    train_dataset = moco.loader_phase2.CustomImageFolder(
        traindir,
