...
--use_seg \
--swa \
--moco_pretrained './checkpoints/finetune/224/resnet34_track2_4096_0.03_128/gpus_4_lr_0.03_bs_128_epochs_200/checkpoint_0199.pth.tar' ;
...
--fine_tune './ckpts/epoch_120_MOCO_DecoupleMix_224_448_SWA_1e-1_cos_lr/NICO-resnet34-track2/model_best_out_090_epochs.pth.tar' ;
...
--cfg mixinginference \
--save_path './results/' \
--model_path './ckpts/epoch_120-200_MOCO_FDG_512_1e-1_cos_lr/NICO-resnet34-track2/teacher/model_best_out_090_epochs.pth.tar' ;
...
do 
    ...
    CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python3 ./main.py \
        ...
        --dist-backend 'nccl' \
        --world-size 1 \
        --pretrained './ckpts/epoch_120-200_MOCO_FDG_512_1e-1_cos_lr/NICO-resnet34-track2/teacher/model_best_out_090_epochs.pth.tar' ;
